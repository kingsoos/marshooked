...
void Hooks::Initialise()
{
	...
	Interfaces::CVar->ConsoleColorPrintf(Color(255, 127, 0, 255), ("\n Insert open menu MarsCheat \n"));
...
void ClanTag()
{
	...
	case 1:
	{
		...
		switch (value) {
		case 0:SetClanTag("MarsCheat", ""); break;
	...
	case 2:
	{
		...
		switch (value) {
		case 0:SetClanTag("Mars    ", ""); break;
		case 1:SetClanTag("Cheat ", ""); break;
		case 2:SetClanTag("MarsCheat  ", ""); break;
		case 3:SetClanTag("MarsCheat  ", ""); break;
		case 4:SetClanTag("MarsCheat ", ""); break;
		case 5:SetClanTag("Cheat ", ""); break;
		case 6:SetClanTag("Mars ", ""); break;
		}
		counter++;
...
void __fastcall PaintTraverse_Hooked(PVOID pPanels, int edx, unsigned int vguiPanel, bool forceRepaint, bool allowForce)
{
	...
	else if (FocusOverlayPanel == vguiPanel)
	{
		...
		}
	    {
			...
			Render::Clear(11, 13, 160, 18, Color(255, 70, 0, 155));
			Render::Text(15, 15, Color(255, 255, 255, 255), Render::Fonts::supremacy, ("MarsCheat fixed by d e w#6840"));
				...
				if (pOwner)
				{
					if (pOwner == pLocal)
					{
						...
						if (g_menu::window.Skins.SkinEnable.GetState())
						{
							...
							short weapon = *pWeapon->m_AttributeManager()->m_Item()->ItemDefinitionIndex();//crash with nade?
