...
#define UI_COL_TABTEXT		Color(255, 169, 0, 255)
...
void CCheckBox::Draw(bool hover)
{
	...
	{
		Render::GradientV(a.x + 2, a.y + 2, 9, 9, Color(255, 255, 255, 255), Color(255, 255, 255, 255));
		Render::Outline(a.x + 2, a.y + 2, 9, 9, Color(0, 0, 0, 255));
	}
	...
	if (Checked)
	{
			...
			{
				{
					...
					Render::GradientV(a.x + 2, a.y + 2, 9, 9, Color(255, 169, 0, 255), Color(0, 0, 0, 255));
				}
			}
				...
				{
					{
						...
						Render::GradientV(a.x + 2, a.y + 2, 9, 9, Color(255, 169, 0, 255), Color(255, 169, 0, 255));
					}
				}
		...
		Render::Outline(a.x + 2, a.y + 2, 9, 9, Color(255, 169, 0, 255));
	}
}
...
{
	POINT a = GetAbsolutePos();
	Render::Text(a.x, a.y, Color(255, 255, 255, 255), Render::Fonts::supremacy, Text.c_str());
}
...
POINT a = GetAbsolutePos();
if (hover)
Render::GradientV(a.x, a.y, m_iWidth, m_iHeight, Color(255, 169, 0, 255), Color(0, 0, 0, 255));
else
Render::GradientV(a.x, a.y, m_iWidth, m_iHeight, Color(45, 45, 45, 255), Color(45, 45, 45, 255));

Render::Outline(a.x, a.y, m_iWidth, m_iHeight, Color(255, 169, 0, 255));
...
Render::Text2(TextX, TextY, Text.c_str(), Render::Fonts::Menu, Color(255, 169, 0, 255));
}
...
void CColorSlider::Draw(bool hover)
{
	...
	Render::Clear(a.x, a.y + 3, m_iWidth, 10, Color(255, 169, 0, 255));
	Render::Outline(a.x, a.y, m_iWidth, 16, Color(255, 169, 0, 255));
...
if (g_menu::window.isOpen())
{
Render::GradientV(a.x, a.y + 1, m_iWidth, 7, Color(255, 255, 255, 255), Color(100, 100, 100, 255));
}
/* void CSlider::Draw(bool hover)
{
	int red;
		...
		{
			{
				...
				Render::GradientV(a.x, a.y + 1, Location, 7, Color(255, 90, 0, 255), Color(50, 50, 50, 255));
			}
		}
		else if (g_menu::window.ColorsTab.ControlColor.GetIndex() == 1)
			if (g_menu::window.isOpen())
			{
				{
					...
					Render::GradientV(a.x, a.y + 1, Location, 7, Color(255, 169, 0, 255), Color(255, 169, 0, 255));
				}
			}
			else if (g_menu::window.ColorsTab.ControlColor.GetIndex() == 2)
				if (g_menu::window.isOpen())
	...
	RECT txtSize = Render::GetTextSize(Render::Fonts::Slider, buffer);
	if (Location == 0)
		Render::Text(a.x + (Location)-txtSize.right / 2 - 2 + 3, a.y + 1, Color(255, 255, 255, 255), Render::Fonts::Slider, buffer);
	else
		Render::Text(a.x + (Location)-txtSize.right / 2 - 2, a.y + 1, Color(255, 255, 255, 255), Render::Fonts::Slider, buffer);
}
...
void CKeyBind::Draw(bool hover)
{
	...
	if (hover)
		...
		Render::Clear(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 4, Color(128, 128, 128, 255));
	...
	Render::Text(a.x + 2, a.y + 2, Color(255, 255, 255, 255), Render::Fonts::supremacy, KeyName);
}
...
void CButton::Draw(bool hover)
{
	...
	if (hover)
		Render::Clear(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 4, Color(255, 169, 0, 255));
	else
		Render::Clear(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 4, Color(255, 169, 0, 255));
	...
	Render::Text(TextX, TextY, Color(255, 169, 0, 255), Render::Fonts::supremacy, Text.c_str());
}
...
void CComboBox::Draw(bool hover)
{
	...
	Render::GradientV(a.x, a.y, m_iWidth, 20, Color(255, 169, 0, 255), Color(0, 0, 0, 255));
	if (GUI.IsMouseInRegion(Region)) Render::GradientV(a.x, a.y, m_iWidth, 20, Color(255, 169, 0, 255), Color(255, 169, 0, 255));
	...
	if (Items.size() > 0)
	{
		...
		if (IsOpen)
		{
			Render::GradientV(a.x, a.y + 20, m_iWidth, Items.size() * 20, Color(255, 255, 255, 255), Color(0, 0, 0, 255));
			...
			for (int i = 0; i < Items.size(); i++)
			{
				...
				{
					Render::GradientV(a.x, a.y + 20 + i * 20, m_iWidth, 20, Color(255, 169, 0, 255), Color(35, 35, 35, 255));
				}

				RECT control_textsize = Render::GetTextSize(Render::Fonts::supremacy, Items[i].c_str());
				if (i == SelectedIndex)
					Render::Text2(a.x + 10, a.y + 20 + (i * 20) + 10 - (control_textsize.bottom / 2), Items[i].c_str(), Render::Fonts::supremacy, Color(255, 169, 0, 255));
				else
					Render::Text2(a.x + 10, a.y + 20 + (i * 20) + 10 - (control_textsize.bottom / 2), Items[i].c_str(), Render::Fonts::supremacy, Color(0, 0, 0, 255));
			}
			Render::Outline(a.x, a.y + 20, m_iWidth, Items.size() * 20, Color(255, 169, 0, 255));
		}
	}
	Vertex_t Verts2[3];
	...
	Render::Polygon(3, Verts2, Color(255, 169, 0, 255));
}
...
void CTextField::Draw(bool hover)
{
	...
	Render::Text(a.x + 2, a.y + 2, Color(255, 169, 0, 255), Render::Fonts::supremacy, cstr);
}
